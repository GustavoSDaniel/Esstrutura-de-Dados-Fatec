def busca_sequencial(lista, val):
    """
    Função que realiza uma busca sequencial em uma lista, procurando por val. Se val for encontrado, retorna a posição de val na lista.
    Caso contrário, retorna o valor convencional -1.
    """
    #Percorre a lista do início ao fim, usando range() e len() (é necessário ter acesso às posições dos elementos)
    for pos in range(len(lista)):
        #Econtra val; retorna a posição onde foi encontrado
